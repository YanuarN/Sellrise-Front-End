 ...
 *  - isPublished  {boolean}   Whether the scenario is published.
 ...
 *  - onPublish    {Function}  Callback when the Publish button is clicked.
 *  - onDelete     {Function}  Callback when the Delete button is clicked.
        ...
        <div className="group bg-white rounded-2xl p-6 shadow-sm border border-slate-200 hover:shadow-xl hover:-translate-y-1 hover:border-blue-200 transition-all duration-300">
            ...
            <div className="flex items-center justify-between pt-4 border-t border-slate-100">
                ...
                <div className="flex gap-2">
                    ...
                    {onPublish && (
                        <Button variant="outline" className="text-xs py-1.5 px-3 h-auto gap-1" onClick={onPublish}>
