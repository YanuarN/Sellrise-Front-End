...
import { Mail, ArrowRight, ArrowLeft, Sparkles, Bot, MessageSquare, LayoutGrid } from 'lucide-react';
...
function ForgotPassword() {
    ...
    const handleResetPassword = (e) => {
        e.preventDefault();
        // Simulate sending an email and redirect
            ...
            <div className="flex flex-col flex-1 items-center justify-center p-8 sm:p-12 relative">
                ...
                <div className="w-full max-w-[420px] space-y-8 animate-[fadeIn_0.5s_ease-out]">
                    ...
                    <div className="mt-8 flex items-center justify-center">
                        <Link to="/login" className="flex items-center gap-2 text-sm font-semibold text-gray-500 hover:text-gray-900 transition-colors">
